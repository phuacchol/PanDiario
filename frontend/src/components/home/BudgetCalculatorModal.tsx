...
// categorías con monto editable + papelera, y barra fija para agregar una
// categoría personalizada nueva.
export function BudgetCalculatorModal({
  ...
  const [tab, setTab] = useState<BudgetType>(initialTab);
      ...
      <View style={styles.backdrop}>
        <View style={[styles.sheet, { backgroundColor: colors.surface }]}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={[styles.catRow, { backgroundColor: colors.surfaceSecondary }]}>
          ...
          <View style={[styles.addRow, { backgroundColor: colors.surfaceTertiary, borderColor: colors.border }]}>
            ...
            <TextInput
              ...
              keyboardType="decimal-pad"
              placeholderTextColor={colors.onSurfaceTertiary}
              style={[styles.addAmountInput, { color: colors.onSurface }]}
...
const styles = StyleSheet.create({
  ...
  sheet: { borderTopLeftRadius: RADIUS.xl, borderTopRightRadius: RADIUS.xl, padding: SPACING.xl, gap: SPACING.md, maxHeight: "85%" },
  ...
  addNameInput: { flex: 2, fontFamily: FONTS.medium, fontSize: FONT_SIZE.base, height: "100%" },
  addAmountInput: { flex: 1, fontFamily: FONTS.medium, fontSize: FONT_SIZE.base, height: "100%" },
